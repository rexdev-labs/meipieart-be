...
`,M=({title:d,description:h,as:f="span",togglePosition:x="right",action:P,...D})=>{const{onToggle:O,toggle:B,expanded:C,id:T,size:y,variant:$,disabled:R}=(0,v.A)(),K=`accordion-content-${T}`,A=`accordion-label-${T}`,j=`accordion-desc-${T}`,L=y==="M"?6:4,I=y==="M"?L:L-2,U=u({expanded:C,disabled:R,variant:$}),W={as:f,fontWeight:y==="S"?"bold":void 0,id:A,textColor:C?"primary600":"neutral700",ellipsis:!0,variant:y==="M"?"delta":void 0},b=C?"primary600":"neutral600",z=C?"primary200":"neutral200",S=y==="M"?`${32/16}rem`:`${24/16}rem`,Z=()=>{R||(B&&!O?(p.warn('Deprecation warning: Usage of "toggle" prop in Accordion component is deprecated. This is discouraged and will be removed in the next major release. Please use "onToggle" instead'),B()):O&&O())},F=(0,t.jsx)(o.k,{justifyContent:"center",borderRadius:"50%",height:S,width:S,transform:C?"rotate(180deg)":void 0,"data-strapi-dropdown":!0,"aria-hidden":!0,as:"span",background:z,cursor:R?"not-allowed":"pointer",onClick:Z,shrink:0,children:(0,t.jsx)(r.J,{as:a.CarretDown,width:y==="M"?`${11/16}rem`:`${8/16}rem`,color:C?"primary600":"neutral600"})});return(0,t.jsx)(_,{paddingBottom:I,paddingLeft:L,paddingRight:L,paddingTop:I,background:U,expanded:C,size:y,justifyContent:"space-between",cursor:R?"not-allowed":"",children:(0,t.jsxs)(i.K,{horizontal:!0,spacing:3,flex:1,maxWidth:"100%",children:[x==="left"&&F,(0,t.jsx)(g,{onClick:Z,"aria-disabled":R,"aria-expanded":C,"aria-controls":K,"aria-labelledby":A,"data-strapi-accordion-toggle":!0,expanded:C,type:"button",flex:1,minWidth:0,...D,children:(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(m.y,{...W,children:d}),h&&(0,t.jsx)(s.Z,{as:"p",id:j,textColor:b,children:h})]})}),x==="right"&&(0,t.jsxs)(i.K,{horizontal:!0,spacing:3,children:[F,P]}),x==="left"&&P]})})}},2407:(E,c,e)=>{"use strict";e.d(c,{$:()=>m,O:()=>v});var t=e(85893),a=e(71893),n=e(41363),l=e(75515),s=e(41580),o=e(11047),i=e(63237);const r=(0,a.default)(o.k)`
  svg {
    height: ${10/16}rem;
    width: ${10/16}rem;
    path {
