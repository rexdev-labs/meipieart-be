...
`,D=(0,a.default)(b.k)`
  ...
  ${f.BF}
`,R=g.forwardRef(({children:v,startIcon:n,endIcon:d,onClick:r,disabled:o=!1,loading:u=!1,...x},M)=>{const m=r&&!o?r:void 0,T=o||u;return(0,e.jsxs)(D,{ref:M,"aria-disabled":T,onClick:m,as:"button",type:"button",...x,children:[(n||u)&&(0,e.jsx)(l.x,{as:"span",paddingRight:2,"aria-hidden":!0,children:u?(0,e.jsx)(S,{children:(0,e.jsx)(s.Loader,{})}):n}),(0,e.jsx)(h.Z,{variant:"pi",textColor:T?"neutral600":"primary600",children:v}),d&&(0,e.jsx)(l.x,{as:"span",paddingLeft:2,"aria-hidden":!0,children:d})]})});R.displayName="TextButton"},20707:(U,E,t)=>{t.d(E,{s:()=>N});var e=t(67294),g=t(71893),a=t(45697),s=t(75228),l=t(14085),h=t(54574),b=t(64777),f=t(63428),P=t(96404),S=t(7681),D=t(11047),R=t(39785),v=t(15585),n=t(75515),d=t(63237),r=t(41580),o=t(88262);const u=g.default.label`
  position: relative;
